...
public class AdminServiceImpl implements AdminService{
	...
	@Override
	public void addBook() {
		System.out.println("새로운 첵을 추가합니다.\n\n");
		
		System.out.print("책 번호: "); //key
		String bookNumber = s.nextLine();
		System.out.println("\n====================분류번호========================");
		System.out.println("A: 문학\tB: 철학\tC: 종교\tD: 사회과학\tE: 자연과학");
		System.out.println("---------------------------------------------------");
	...
	public void deleteBook() {
		...
		BookVO bookNumberCheck = bookDao.selectBook(bookNumber);
			if(bookNumberCheck == null){
				System.out.println("일치하는 책번호가 없습니다.\n책번호를 다시 입력해주세요.");
				System.out.println("---------------------------------------------------\n");
			}else{
	...
	public void allSendMessage() {
		...
		System.out.println("");
		System.out.println("쪽지 제목을 입력해주세요.");
	...
	public void oneSendMessage() {
		...
		post.setPostTitle(title);
		post.setPostContents(content);
		post.setSendDate(DateUtil.dateToString(today));
		post.setSenderID(Session.loginUser.getUserID());
	...
	public void wishBookList() {
		...
		System.out.println("\n===================희망 도서 리스트=====================");
		System.out.println("도서신청번호\t도서명\t저자");
		System.out.println("---------------------------------------------------");
		for(int i =0; i< wishList.size(); i++){
			RequestVO book = wishList.get(i);
			System.out.println(book.getRequestNumber()+"\t"+book.getBookName()+"\t"+book.getWriter());
		}
		System.out.println("===================================================\n");
	}
	...
	public void addNotice() {
		ArrayList<NoticeVO> noticeNumber = noticeDao.selectNoticeList();
		
		String userID = Session.loginUser.getUserID();
		
		int num= noticeNumber.size()+1;
		String number = Integer.toString(num);
		
		System.out.println("");
		System.out.print("공지 제목을 입력해주세요.");
		String title = s.nextLine();
		System.out.print("공지 내용을 입력해주세요.");
		...
		Date date = new Date();
		notice.setWriteDate(DateUtil.dateToString(date));
